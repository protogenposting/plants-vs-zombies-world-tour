...
if(room==level11)
{
	zomb=choose(basiczombie,coneheadzombie,bucketheadzombie,gardener)
}
if(room==level12)
{
	zomb=choose(basiczombie,coneheadzombie,bucketheadzombie,gardener)
...
if(room==level15)
{
	zomb=choose(basiczombie,coneheadzombie,bucketheadzombie,gardener,octozomb,grave,tombraiser)
}
